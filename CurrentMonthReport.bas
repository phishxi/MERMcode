...
Begin Report
    ...
    RecSrcDt = Begin
        0xab572e0a2909e540
    End
    RecordSource ="CurrentMonth"
    Caption ="CurrentMonthReport"
    DatasheetFontName ="Calibri"
    PrtMip = Begin
        0x6801000068010000680100006801000000000000002d00004a01000001000000 ,
        ...
        Begin FormHeader
            ...
            Begin
                ...
                Begin Label
                    ...
                    ForeColor =8355711
                    Name ="Label20"
                    Caption ="*Covers current and subsequent month."
...
StrPathFile = "C:\Users\G87022\Downloads\Report1.pdf"
DoCmd.OutputTo acOutputReport, "CurrentMonthReport", acFormatPDF, StrPathFile, True, acExportQualityScreen
End Sub
