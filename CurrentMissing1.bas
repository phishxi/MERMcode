...
Begin Report
    ...
    RecSrcDt = Begin
        0xd9a0a67f78f2e440
    End
    RecordSource ="CurrentMissing"
    Caption ="CurrentMissing1"
    DatasheetFontName ="Calibri"
    PrtMip = Begin
        0x68010000680100006801000068010000000000006c2a00006801000001000000 ,
                    ...
                    OnClickEmMacro = Begin
                        ...
                        Begin
                            Comment ="_AXL:<?xml version=\"1.0\" encoding=\"UTF-16\" standalone=\"no\"?>\015\012<UserI"
                                "nterfaceMacro For=\"Command17\" Event=\"OnClick\" xmlns=\"http://schemas.microso"
...
StrPathFile = "C:\Users\G87022\Downloads\Report12.xls"
DoCmd.OutputTo acOutputReport, "CurrentMissing1", acFormatXLS, StrPathFile
End Sub
...
DoCmd.OutputTo acOutputReport, "CurrentMissing1", acFormatPDF, StrPathFile, True, acExportQualityScreen
End Sub
