...
Begin Form
    ...
    Tag ="SplitList"
    Filter ="(Year([QryAllMERM].[EventDate])=Year(Date()))"
    Picture ="office.png"
    RecSrcDt = Begin
        0x8de6db55290ae540
    End
    RecordSource ="QryAllMERM"
    DatasheetFontName ="Calibri"
    PrtMip = Begin
        0xa0050000a0050000a0050000a0050000000000002f2b0000ba27000001000000 ,
            ...
            OnClickEmMacro = Begin
                ...
                Begin
                    Comment ="_AXL:<?xml version=\"1.0\" encoding=\"UTF-16\" standalone=\"no\"?>\015\012<UserI"
                        "nterfaceMacro For=\"FormHeader\" Event=\"OnClick\" xmlns=\"http://schemas.micros"
                        "oft.com/office/accessservices/2009/11/application\" xmlns:a=\"http://schemas.mic"
                        "rosoft.com/office/accessservices"
                End
                Begin
                    Comment ="_AXL:/2009/11/forms\"><Statements><Action Name=\"CloseWindow\"/></Statements></U"
                        "serInterfaceMacro>"
                End
            End
            Begin
                Begin Label
                    ...
                    FontSize =18
                    Name ="Auto_Title0"
                    Caption ="All items due over the next 365 days"
                ...
                Begin CommandButton
                    ...
                    OnClickEmMacro = Begin
                        ...
                        Begin
                            Comment ="_AXL:<?xml version=\"1.0\" encoding=\"UTF-16\" standalone=\"no\"?>\015\012<UserI"
                                "nterfaceMacro For=\"Command295\" Event=\"OnClick\" xmlns=\"http://schemas.micros"
                                "oft.com/office/accessservices/2009/11/application\" xmlns:a=\"http://schemas.mic"
                                "rosoft.com/office/accessservices"
                        End
                        Begin
        ...
        Begin Section
            ...
            Begin
                Begin TextBox
                    ...
                    Tag ="DrillToDetails~FormName=Contact Details~SourceID=ID"
                    ...
                    OnDblClickEmMacro = Begin
                        ...
                        Begin
                            Comment ="_AXL:<?xml version=\"1.0\" encoding=\"UTF-16\" standalone=\"no\"?>\015\012<UserI"
                                "nterfaceMacro For=\"Last Name\" xmlns=\"http://schemas.microsoft.com/office/acce"
                                "ssservices/2009/11/application\"><Statements><Action Name=\"OnError\"/><Conditio"
                                "nalBlock><If><Condition>[Form]."
                        End
                        Begin
                            Comment ="_AXL:[Dirty]</Condition><Statements><Action Name=\"SaveRecord\"/></Statements></"
                                "If></ConditionalBlock><ConditionalBlock><If><Condition>[MacroError].[Number]&lt;"
                                "&gt;0</Condition><Statements><Action Name=\"MessageBox\"><Argument Name=\"Messag"
                                "e\">=[MacroError].["
                        End
                        Begin
                            Comment ="_AXL:Description]</Argument></Action><Action Name=\"StopMacro\"/></Statements></"
                                ...
                                "ument></Action><ConditionalBlock><If><Condition>Not IsNull([ID])</Condition><Sta"
                                "tements><Action Nam"
                        End
                        Begin
                            Comment ="_AXL:e=\"OpenForm\"><Argument Name=\"FormName\">Contact Details</Argument><Argum"
                                "ent Name=\"WhereCondition\">=\"[ID]=\" &amp; [ID]</Argument><Argument Name=\"Win"
                                "dowMode\">Dialog</Argument></Action></Statements></If></ConditionalBlock></State"
                                "ments></UserInterfaceMa"
                        End
                        Begin
                            Comment ="_AXL:cro>"
                        End
                ...
                Begin TextBox
                    ...
                    OnDblClickEmMacro = Begin
                        ...
                        Begin
                            Comment ="_AXL:<?xml version=\"1.0\" encoding=\"UTF-16\" standalone=\"no\"?>\015\012<UserI"
                                "nterfaceMacro For=\"First Name\" xmlns=\"http://schemas.microsoft.com/office/acc"
                        ...
                        Begin
                            Comment ="_AXL:[Description]</Argument></Action><Action Name=\"StopMacro\"/></Statements><"
                                ...
                                "gument></Action><ConditionalBlock><If><Condition>Not IsNull([ID])</Condition><St"
                                "atements><Action Na"
                        End
                        Begin
                            Comment ="_AXL:me=\"OpenForm\"><Argument Name=\"FormName\">Contact Details</Argument><Argu"
                                "ment Name=\"WhereCondition\">=\"[ID]=\" &amp; [ID]</Argument><Argument Name=\"Wi"
